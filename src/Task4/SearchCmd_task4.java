...
public class SearchCmd_task4 {
   ...
   public static void main(String[] args) throws IOException {
      ...
      HTMLlist l = Searcher_task4.readHtmlList(args[0]),
              start = l;
      ...
      while (!quit) {
         ...
         if(Searcher_task4.exists(l, name)) {  // check if the word is in the file
            System.out.println(name + " exists on the following pages:");
           URL temp = Searcher_task4.getNode(l, name).urls;
           while(temp != null){
